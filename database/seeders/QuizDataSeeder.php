        ...
        $data = [
            ...
            'sri-lankan-history' => [
                [
                    ...
                    'difficulty' => 'medium',
                    'questions' => [
                        ['text' => 'What was the ancient name of Sri Lanka?', 'explanation' => 'Sri Lanka has been known by many names: "Lanka" in ancient texts, "Serendip" to Arab traders (from Sanskrit Siṃhaladvīpa), and "Ceylon" during the colonial era. All three were historical names for the island.', 'options' => [['text' => 'Serendip', 'correct' => false], ['text' => 'Ceylon', 'correct' => false], ['text' => 'Lanka', 'correct' => false], ['text' => 'All of the above', 'correct' => true]]],
